...
from markdown_editor.utils import compatible_staticpath
...
class MarkdownWidget(forms.Textarea):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.lib=markdown_settings.STATIC_URL+"markdown_editor/lib/"
    ...
    def _media(self):
        return forms.Media(
            css={
                "all": (compatible_staticpath("markdown_editor/css/editormd.css"),)
            },
            js=(
                compatible_staticpath("markdown_editor/js/jquery.min.js"),
                compatible_staticpath("markdown_editor/js/editormd.min.js"),
